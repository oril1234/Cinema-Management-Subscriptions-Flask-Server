...
This respository is of one of 2 cinema management system servers. It provides the [main server](https://github.com/oril1234/Cinema-Management-System-Main-Server) with 3 web services: 
